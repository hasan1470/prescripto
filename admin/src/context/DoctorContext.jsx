...
const DoctorContextProvider = ( props ) => {
  ...
  const getAppointments = async () => {
    try {
      ...
      const {data} = await axios.get(backendUrl + '/api/doctors/doctor-appointments', {headers: {dToken}})
  ...
  const getDashData = async () => {
    ...
    try {
      ...
      const {data} = await axios.get(backendUrl + '/api/doctors/doctor-dashboard', {headers: {dToken}})
      if(data.success) {
  ...
  const getProfileData = async () => {
    ...
    try {
      ...
      const {data} = await axios.get(backendUrl + '/api/doctors/doctor-profile', {headers: {dToken}})
      if(data.success) {
